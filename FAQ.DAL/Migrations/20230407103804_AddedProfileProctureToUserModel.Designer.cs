...
namespace FAQ.DAL.Migrations
{
    ...
    [Migration("20230407103804_AddedProfileProctureToUserModel")]
    partial class AddedProfileProctureToUserModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FAQ.DAL.Models.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FAQ.DAL.Models.Answer", b =>
                {
                    b.HasOne("FAQ.DAL.Models.Answer", "ParentAnswer")
            ...
            modelBuilder.Entity("FAQ.DAL.Models.QuestionTag", b =>
                {
                    ...
                    b.HasOne("FAQ.DAL.Models.Tag", "Tag")
                        .WithMany("QuestionTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FAQ.DAL.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
